...
/* this file consists of several sections(단계 구성) 1, 2, 3번만 설정
   to create a working combination you must at  ㅠ    ㅠleast make your choices in section 1.
   ...
   2 - COPTER TYPE SPECIFIC OPTIONS - you likely want to check for options for your copter type (옵션 설정)
   3 - RC SYSTEM SETUP(조종기 수신기, 통신, BWM 방식을 사용하고 있다.)
   ...
   7 - TUNING & DEVELOPER - if you know what you are doing; you have been warned (튜닝 설정)
...
//#define TRI
//#define QUADP
#define QUADX (드론 타입은 쿼드콥터인데 X모양)
//#define Y4
//#define Y6
//#define HEX6
//#define HEX6X
...
#define MINTHROTTLE 1000 // special ESC (simonk) (드론 최소 스로틀 값)

/****************************    Motor maxthrottle    *******************************/
/* this is the maximum value for the ESCs at full power, this value can be increased up to 2000 */
#define MAXTHROTTLE 1850 //드론 최대 스로틀 값
...
#define FAILSAFE_RTH            //Failsafe will Return To Home, if FAILSAFE_LAND is also enabled, it will autoland once at back home.
#define FAILSAFE_IGNORE_LAND    //Failsafe will be ignored if land is alread in progress
